...
hl.window_rule({
    match  = { class = "org.carbon.configeditor" },
    float  = true,
...
-- Discord: tile normally with clean edge spacing (if floated manually, fit comfortably)
hl.window_rule({ match = { class = "discord" }, size = "1200 660", center = true })
...
hl.window_rule({ match = { class = "equibop|vesktop|whatsapp" }, workspace = "special:communication" })
